...
PREV_REPLY_MESSAGE = {}
PM = f"""Hello. You are accessing the availabe chat menu of my boss, {mention}.
__Let's make this smooth and let me know why you are here.__
**Choose one of the following reasons why you are here:**
`a`. To message my boss
`b`. To spam my boss inbox.
`c`. To enquire something
`d`. To request something\n"""
ONE = """__Okay. Your request has been registered. Do not spam my boss inbox.You can expect a reply within 12 light years. He/She is a busy man, unlike you probably.__
